...
//                    new ReflectionFactory.GetReflectionFactoryAction());
     ...
     */
    private static String forceDefaultConstructor(Class cl) throws Exception {
...
//        System.out.println("Cons: " + cons);
    ...
    private static String getSerializableConstructorOld(Class cl) {
        Class initCl = cl;
...
//            }
		cons = "";
//            		reflFactory.newConstructorForSerialization(cl, cons);
//            cons.setAccessible(true);
//            System.out.println("Cons: " + cons);
		return "";
    }
